...
<div class="form">
    <form action="${pageContext.request.contextPath}/table/reliable" method="post" >
        <div class="item">
            <span>姓名:&nbsp;&nbsp;&nbsp;&nbsp;</span>
            <label><input type="text" name="name"  class="width" placeholder="请输入您的称呼" /></label>
        </div>
        <div class="item">
            <span>电话号码:</span>
            <label><input type="text" class="width" name="phone" placeholder="电话号" /></label>
        </div>
        <div class="item">
            <span>收获地址:</span>
            <label><input type="text" class="width" name="address" placeholder="请填写致区域单位" /></label>
        </div>
